...
public class MessagesFragment extends Fragment {
    ...
    private String append = "/messages";
    ...
    public MessagesFragment(String conversationId) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerMsgs.setHasFixedSize(true);
        binding.recyclerMsgs.setLayoutManager(new LinearLayoutManager(context));

        messages = new ArrayList<>();
        adapter = new MessageAdapter(messages, context);
        binding.recyclerMsgs.setAdapter(adapter);

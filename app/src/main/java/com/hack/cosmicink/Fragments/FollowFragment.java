...
public class FollowFragment extends Fragment {
    ...
    private static final String TAG = "Follow Fragment";
    ...
    private String append = "/follow-ups";
    ...
    public FollowFragment(String conversationId) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerFollows.setHasFixedSize(true);
        binding.recyclerFollows.setLayoutManager(new LinearLayoutManager(context));

        messages = new ArrayList<>();
        adapter = new MessageAdapter(messages, context);
        binding.recyclerFollows.setAdapter(adapter);
    ...
    private void retrieveMessages(JSONObject response) {
        try {
            JSONArray messageArray = response.getJSONArray("followUps");

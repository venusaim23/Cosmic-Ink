...
import com.hack.cosmicink.databinding.FragmentActionsBinding;
...
public class ActionsFragment extends Fragment {
    ...
    private static final String TAG = "Actions Fragment";
    ...
    private String append = "/action-items";
    ...
    public ActionsFragment(String conversationId) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.recyclerActions.setHasFixedSize(true);
        binding.recyclerActions.setLayoutManager(new LinearLayoutManager(context));

        messages = new ArrayList<>();
        adapter = new MessageAdapter(messages, context);
        binding.recyclerActions.setAdapter(adapter);
...
//                headers.put("Content-Type", "application/json");
    ...
    private void retrieveMessages(JSONObject response) {
        try {
            JSONArray messageArray = response.getJSONArray("actionItems");
